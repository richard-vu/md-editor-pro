...
/**
 * Custom Text Editor Provider for Markdown files with fullscreen WYSIWYG (no split view)
 */
export class MarkdownEditorProviderFullscreen implements vscode.CustomTextEditorProvider {
    public static register(context: vscode.ExtensionContext): vscode.Disposable {
        const provider = new MarkdownEditorProviderFullscreen(context);
        const providerRegistration = vscode.window.registerCustomEditorProvider(
            MarkdownEditorProviderFullscreen.viewType,
            provider,
            {
                webviewOptions: {
    ...
    private static readonly viewType = 'mdEditorPro.fullscreen';
    ...
    /**
     * Get HTML content for webview (fullscreen editor, no preview)
     */
...
<head>
	...
	<title>MD Editor Pro - WYSIWYG Fullscreen</title>
</head>
<body class="theme-${theme} fullscreen-mode">
	<!-- Toolbar -->
	...
	<div id="fullscreen-container" class="fullscreen-container">
		<div id="editor-pane" class="pane editor-pane fullscreen-pane">
			<textarea id="markdown-editor" spellcheck="false"></textarea>
		</div>
	</div>

	<!-- Load Markdown-it and Mermaid from CDN (even though not shown, still needed for syntax) -->
